      ...
      child: GestureDetector(
        ...
        child: ForceLTR(
          Tooltip(
            ...
            child: QrImageView(
              data: _hostName,
              size: MediaQuery.of(context).size.height * 0.23,
              backgroundColor: Colors.transparent,
              padding: EdgeInsets.all(MediaQuery.of(context).size.height * 0.029),
              eyeOuter: QrEyeOuter.keep,
              eyeInner: QrEyeInner.square,
              dataModuleStyle: QrDataModuleStyle.square,
              errorCorrectionLevel: QrErrorCorrectLevel.h,
              semanticLabel: 'QR Code for file transfer',
            ),
          ),
        ),
      ),
